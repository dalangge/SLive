...
<xsl:template match="/">
    <html>
        <head>
            <title>HTTP LIVE statistics</title>
        </head>
        <body>
            <xsl:apply-templates select="http_live"/>
            <hr/>
            Generated by <a href='https://github.com/dalangge/SLive'>
            nginx-http-live-module</a>&#160;<xsl:value-of select="/rtmp/nginx_rtmp_version"/>,
            <a href="http://nginx.org">nginx</a>&#160;<xsl:value-of select="/http_live/nginx_version"/>,
            pid <xsl:value-of select="/http_live/pid"/>,
            built <xsl:value-of select="/http_live/built"/>&#160;<xsl:value-of select="/http_live/compiler"/>
        </body>
    </html>
</xsl:template>

<xsl:template match="http_live">
